...
const submit = () => {
    // We need to use post with _method for file uploads to work properly
    form.transform((data) => ({
        ...data,
            ...
            <form @submit.prevent="submit">
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" v-model="form.slug" id="slug" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <div v-if="category.image" class="mt-2">
                            ...
                            <img :src="`/storage/${category.image}`" class="mt-1 h-20 object-cover rounded" :alt="category.name">
                        </div>
                    </div>
